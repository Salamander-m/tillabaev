    ...
    if num == '':
        ...
        if check_bin(num): # если функция с принятым значением передает True(bool)
            ...
            if convert_system not in ['2','8','16','10']: # если желаемая сс не 2 10 16
                return ('ERROR_204') # ошибка если желаемое основание для перевода не 2 8 16 10
        else:
            return ('ERROR_203') # возращает ошибку, если число не в 2 сс или меньше нуля
